...
var Animation = /** @class */function (_super) {
    ...
    function Animation(props) {
        ...
        _this.cloneElement = function (ref, className, style, events) {
            ...
            if (children) {
                return React.cloneElement(children, __assign({ className: (children.props.className || "") + " " + className, ref: ref, style: _extends({}, children.props.style || {}, style) }, events));
            } else {
                return null;
            }
        };
        _this.calcCss = function () {
            ...
            return __assign({}, end ? end : {}, { transform: "translate3d(" + transX + "px," + transY + "px,0)" + (start && void 0 !== start.scale ? " scale(" + start.scale + ")" : "") }, delay ? { transitionDelay: delay + "ms" } : {}, { transitionDuration: duration + "ms", transitionProperty: "transform", transitionTimingFunction: timing }, origin ? { transformOrigin: origin } : {}, start && start.opacity ? { opacity: start.opacity } : {});
        };
        _this.calcRevert = function (props) {
            ...
            return __assign({ transform: "translate3d(" + transX + "px," + transY + "px,0)" + (start && void 0 !== start.scale ? " scale(" + start.scale + ")" : "") }, delay ? { transitionDelay: delay + "ms" } : {}, { transitionDuration: duration + "ms", transitionProperty: "transform", transitionTimingFunction: timing }, origin ? { transformOrigin: origin } : {}, start && start.opacity ? { opacity: start.opacity } : {});
        };
    ...
    Animation.prototype.componentDidUpdate = function () {
        ...
        if (this.enterOrLeave === "enter" && animType === "css") {
            ...
            window.requestAnimationFrame(function () {
                _this.wrapElement.style.transform = "translate3d(0,0,0)" + (start && void 0 !== start.scale ? " scale(1)" : "");
                start && start.opacity && (_this.wrapElement.style.opacity = "1");
            });
        }
    };
